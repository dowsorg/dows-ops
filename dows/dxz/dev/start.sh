...
sudo docker compose -f /findsoft/hep/paas/dev/mysql.yml up -d
sudo docker compose -f /findsoft/hep/paas/dev/redis.yml up -d
sudo docker compose -f /findsoft/hep/paas/dev/pdf.yml up -d

#启动saas
sudo echo -e "\033[32m 3.running saas docker-compose  \033[0m"
docker compose -f /findsoft/hep/saas/dev/api/admin/docker-compose.yml down
docker compose -f /findsoft/hep/saas/dev/h5/admin/docker-compose.yml down
docker compose -f /findsoft/hep/saas/dev/h5/user/docker-compose.yml down

docker compose -f /findsoft/hep/saas/dev/api/admin/docker-compose.yml up -d
docker compose -f /findsoft/hep/saas/dev/h5/admin/docker-compose.yml up -d
docker compose -f /findsoft/hep/saas/dev/h5/user/docker-compose.yml up -d

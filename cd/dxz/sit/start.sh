...
## api
#sudo docker rmi -f "$docker_registry/wozth/dxz-admin-sit:1.0.230821"
## h5教师端
#sudo docker rmi -f "$docker_registry/wozth/h5-dxz-admin-sit:1.0.230826"
## h5学生端
#sudo docker rmi -f "$docker_registry/wozth/h5-dxz-user-sit:1.0.230826"

sudo docker images

#启动paas
sudo echo -e "\033[32m 2.running paas docker-compose  \033[0m"
sudo docker compose -f /wozth/dxz/paas/sit/mysql.yml up -d
sudo docker compose -f /wozth/dxz/paas/sit/redis.yml up -d
sudo docker compose -f /wozth/dxz/paas/sit/pdf.yml up -d

#启动saas
sudo echo -e "\033[32m 3.running saas docker-compose  \033[0m"
docker compose -f /wozth/dxz/saas/sit/api/admin/docker-compose.yml down
docker compose -f /wozth/dxz/saas/sit/h5/admin/docker-compose.yml down
docker compose -f /wozth/dxz/saas/sit/h5/user/docker-compose.yml down

docker compose -f /wozth/dxz/saas/sit/api/admin/docker-compose.yml up -d
docker compose -f /wozth/dxz/saas/sit/h5/admin/docker-compose.yml up -d
docker compose -f /wozth/dxz/saas/sit/h5/user/docker-compose.yml up -d

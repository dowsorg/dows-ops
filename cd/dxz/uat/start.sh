...
sudo docker compose -f /wozth/dxz/paas/uat/mysql.yml up -d
sudo docker compose -f /wozth/dxz/paas/uat/redis.yml up -d
sudo docker compose -f /wozth/dxz/paas/uat/pdf.yml up -d

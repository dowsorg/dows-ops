...
## api
#sudo docker rmi -f "$docker_registry/wozth/dxz-admin-uat:1.0.230821"
## h5教师端
#sudo docker rmi -f "$docker_registry/wozth/h5-dxz-admin-uat:1.0.230826"
## h5学生端
#sudo docker rmi -f "$docker_registry/wozth/h5-dxz-user-uat:1.0.230826"
...
sudo docker compose -f $path/mysql.yml down
sudo docker compose -f $path/redis.yml down
sudo docker compose -f $path/pdf.yml down
sudo docker compose -f $path/minio.yml down
sudo docker compose -f $path/elasticsearch.yml down

sudo docker compose -f $path/mysql.yml up -d
sudo docker compose -f $path/redis.yml up -d
sudo docker compose -f $path/pdf.yml up -d
sudo docker compose -f $path/minio.yml up -d
sudo docker compose -f $path/elasticsearch.yml up -d
#
##启动saas
#sudo echo -e "\033[32m 3.running saas docker-compose  \033[0m"
#docker compose -f /wozth/dxz/saas/uat/api/admin/docker-compose.yml down
#docker compose -f /wozth/dxz/saas/uat/h5/admin/docker-compose.yml down
#docker compose -f /wozth/dxz/saas/uat/h5/user/docker-compose.yml down
#
#docker compose -f /wozth/dxz/saas/uat/api/admin/docker-compose.yml up -d
#docker compose -f /wozth/dxz/saas/uat/h5/admin/docker-compose.yml up -d
#docker compose -f /wozth/dxz/saas/uat/h5/user/docker-compose.yml up -d
